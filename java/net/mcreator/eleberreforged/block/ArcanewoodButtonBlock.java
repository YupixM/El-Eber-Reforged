...
public class ArcanewoodButtonBlock extends EleberReforgedModElements.ModElement {
	@ObjectHolder("eleber_reforged:arcanewood_button")
	public static final Block block = null;

	public ArcanewoodButtonBlock(EleberReforgedModElements instance) {
		super(instance, 66);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("arcanewood_button");
		}
