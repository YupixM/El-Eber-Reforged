...
import net.mcreator.eleberreforged.gui.ResearchtableGUIGui;
...
public class ResearchtableBlock extends EleberReforgedModElements.ModElement {
	@ObjectHolder("eleber_reforged:researchtable")
	public static final Block block = null;
	@ObjectHolder("eleber_reforged:researchtable")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public ResearchtableBlock(EleberReforgedModElements instance) {
		super(instance, 23);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("researchtable"));
		}
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("researchtable");
		}
