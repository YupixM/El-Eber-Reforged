...
public class ArcanewoodFenceBlock extends EleberReforgedModElements.ModElement {
	@ObjectHolder("eleber_reforged:arcanewood_fence")
	public static final Block block = null;

	public ArcanewoodFenceBlock(EleberReforgedModElements instance) {
		super(instance, 63);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("arcanewood_fence");
		}
