...
public class ArcanewoodStairsBlock extends EleberReforgedModElements.ModElement {
	@ObjectHolder("eleber_reforged:arcanewood_stairs")
	public static final Block block = null;

	public ArcanewoodStairsBlock(EleberReforgedModElements instance) {
		super(instance, 61);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("arcanewood_stairs");
		}
