...
public class ArcanewoodLeavesBlock extends EleberReforgedModElements.ModElement {
	@ObjectHolder("eleber_reforged:arcanewood_leaves")
	public static final Block block = null;

	public ArcanewoodLeavesBlock(EleberReforgedModElements instance) {
		super(instance, 60);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("arcanewood_leaves");
		}
